...
### Upon playing audio into the equalizer, move the knobs accordingly and observe the change in sound. Cutting the low frequencies should give a hollow sound on headphones, and cutting the high frequencies will make it harder to hear the audio on laptop or external device speakers.
